// Fashion Image Search v20.0 - Real High Accuracy Model
// 실제 작동하는 고정확도 모델 (CocoSSD + MobileNet 조합)
// 2025-01-03

console.log('🚀 Fashion Search v20.0 - Real High Accuracy');

class LuxuryFashionSearchApp {
    constructor() {
        this.version = 'v20.0.0-REAL-HIGH-ACCURACY';
        this.dbName = 'fashionSearchDB_v20_0';
        this.db = null;
    ...
    async loadCocoSsd() {
        try {
            ...
            console.log('ℹ️ COCO-SSD 로드 실패, PoseNet 시도:', error.message);
    ...
    async loadPoseNet() {
        try {
            ...
            // PoseNet은 사람 감지용이므로 가방에는 적합하지 않음
            // 대신 더 큰 MobileNet 사용
    ...
    setupUI() {
        const html = `
            <div id="fashionSearchApp">
                <h1>🎯 Fashion Image Search v20.0</h1>
