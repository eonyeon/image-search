        ...
        const html = `
            <div id="fashionSearchApp">
                ...
                <div class="mode-buttons">
                    <button onclick="app.switchMode('search')" class="mode-btn active">🔍 검색 모드</button>
                    <button onclick="app.switchMode('index')" class="mode-btn">📁 인덱싱 모드</button>
                    <button onclick="app.switchMode('debug')" class="mode-btn">🧪 디버그 모드</button>
                </div>
                ...
                <div id="indexMode" class="mode-content" style="display:none;">
                    <button onclick="app.selectFolder()">📂 폴더 선택</button>
                    <button onclick="app.reindexWithML()">🤖 ML 재인덱싱</button>
                    <div id="indexProgress"></div>
                </div>
                
                <div id="debugMode" class="mode-content" style="display:none;">
                    <div class="debug-buttons">
                        <button onclick="app.testBrandExtraction()">🧪 브랜드 추출 테스트</button>
                        <button onclick="app.compareModels()">📊 모델 비교</button>
                        <button onclick="app.validateDB()">✔️ DB 검증</button>
                        <button onclick="app.clearCache()">🗑️ 캐시 초기화</button>
                        <button onclick="app.exportEmbeddings()">💾 임베딩 내보내기</button>
                        <button onclick="app.clearAndReload()">💣 완전 초기화</button>
                    </div>
